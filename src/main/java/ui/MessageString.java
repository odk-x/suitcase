...
public class MessageString {
  ...
  public static final String VISIT_WEB_ERROR = "Please visit" + AGGREGATE + "web interface for error detail.";
  ...
  public static final String HTTP_IO_ERROR = UNABLE_PREFIX + "reach " + AGGREGATE + " server.";
  ...
  public static final String AGG_EMPTY = AGGREGATE + " address" + CANNOT_EMPTY_SUFFIX;
  ...
  public static final String OVERWRITE_CSV = "This CSV has already been downloaded. Delete existing CSV and download data from Aggregate server?";
}
